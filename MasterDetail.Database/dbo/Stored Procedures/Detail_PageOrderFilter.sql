    ...
    -- Description:	Get from table Detail by PageOrderFilter conditions
    -- =============================================
    CREATE PROCEDURE [dbo].[Detail_GetByPageSortFilter]
        @Skip	                BIGINT = 0,
    ...
    BEGIN
      ...
      DECLARE @SelectCountSQL nvarchar(1000) = ' SELECT Count(*) ';
        ...
        IF (@IncludeTotalCount = 1) BEGIN
          Declare @SelectCountDataSourceSql nvarchar(1000) = ' SELECT Count(*) from [dbo].[Detail]';
